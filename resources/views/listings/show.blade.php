    ...
    <div class="mx-4">
        <x-card>
            <div class="flex flex-col items-center justify-center text-center">
                <img class="w-48 mr-6 mb-6 object-contain" src="{{ $listing->logo ? asset('storage/' . $listing->logo) : asset('images/no-image.png') }}" alt=""/>
        ...
        <x-card class="mt-4 p-2 flex space-x-6">
            <a href="/listings/{{$listing->id}}/edit">
                <i class="fa-solid fa-pencil px-1"></i>Edit
            </a>
            ...
            <form action="/listings/{{$listing->id}}" method="POST">
                ...
                <button class="text-red-500"><i class="fa-solid fa-trash px-1"></i>Delete</button>
            </form>
        </x-card>
    </div>
</x-layout>